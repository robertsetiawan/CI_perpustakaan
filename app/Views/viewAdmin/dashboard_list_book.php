...
<body>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group" id="list-kategori" style="cursor: pointer;">
                                            <li id="default-category" class="active list-group-item d-flex justify-content-between align-items-center" onclick="ajaxGetAllBookFromDatabaseByIdKategori(0)">
    ...
    <script>
        $(function() {
            ajaxGetAllBookFromDatabaseByIdKategori(0)
        ...
        function ajaxGetAllBookFromDatabaseByIdKategori(idKategori) {
