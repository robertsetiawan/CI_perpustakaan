                ...
                <div id="auth-left">
                    ...
                    <form action="<?= base_url('/admin/login') ?>" method="POST">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="nama" class="form-control form-control-xl" placeholder="Username">
                        ...
                        <div class="form-check form-check-lg d-flex align-items-end">
                            <input class="form-check-input me-2" name="keeplogin" type="checkbox" value="true" id="flexCheckDefault">
