                        ...
                        <div class="card-body">
                            <?php if (session()->getFlashData('pesan')) : ?>
                                <div class="alert alert-success">
                                    <h5 class="alert-heading">Buku telah dikembalikan. Terima kasih! :)</h5>
                                    ...
                                    <?php foreach ($peminjaman as $data) : ?>
                                        <?php if (empty($data['tgl_kembali'])) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data['judul'] ?></td>
                                                <td>
                                                    <form action="<?= base_url('/dashboard/return_book/' . $data['idtransaksi'] . '/' . $data['idbuku'] . '/' . $data['tgl_pinjam']); ?>" method="POST" class="d-inline">
                                                        <?= csrf_field() ?>
